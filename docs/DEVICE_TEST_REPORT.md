...
Giữ profile 15 fps, LCD 40 MHz và SD 20 MHz. Chép media mới bằng đầu đọc thẻ theo [MEDIA_TRANSFER.md](MEDIA_TRANSFER.md), thử hết các chế độ phát và âm lượng, rồi ghi lại mọi trường hợp tự thoát cùng log `reason`.
